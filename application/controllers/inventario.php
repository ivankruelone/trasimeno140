...
//////////////////////////////////////////////////////////////////////////
	...
	public function tabla_control()
	{
       ...
       $data['titulo'] = "Inventario de Productos de Segpop";
       $data['tit'] = "Captura de Inventario";
   ...
   function imprime_c()
	{
            ...
            <tr>
            <td colspan=\"5\" align=\"center\">INVENTARIO DE ALMACEN DE SEGPOP</td>
            </tr>
            </table>";
...
//////////////////////////////////////////////////////////////////////////
	...
	public function tabla_inv_suc()
	{
       ...
       $data['suc'] = $suc;
       $data['titulo'] = "Inventario de Productos";
       $data['contenido'] = "inventario/inv_form_alta";
...
///////////////////////////////////////////////////////////////////////////
 function insert_d_inv()
    ...
    $this->load->model('inventario_model');
    $this->inventario_model->create_member_d_inv($clave,$lote,$cad,$can,$pro,$cod);
    redirect('inventario/tabla_control');
